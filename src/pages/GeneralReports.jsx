...
import { FileText, Download, Loader2, ArrowUpRight, ArrowDownLeft, ArrowUpDown, ArrowUp, ArrowDown, ArrowLeft } from 'lucide-react'
        ...
        <div>
            <div className="mb-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">{t('reports.stockAndMovements')}</h2>
