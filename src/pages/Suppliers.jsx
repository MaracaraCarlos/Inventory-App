...
export default function Suppliers() {
    ...
    const fetchSuppliers = async () => {
        setLoading(true)
        try {
            const { data, error } = await supplierRepository.getAllSuppliers()
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const { error } = await supplierRepository.deleteSupplier(id)
            if (error) throw error
            fetchSuppliers()
        } catch (error) {
        ...
        <div>
            <div className="mb-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">{t('suppliers.title')}</h2>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div className="p-4 border-b border-gray-100 dark:border-gray-700">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                        />
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                        {searchTerm ? t('suppliers.noResults') : t('suppliers.empty')}
                    </div>
                ) : (
